...
exports.verifystudent = async (req,res) => {
    ...
    try {
        ...
        const token = jwt.sign(payload, '10h');
...
exports.forgotpasswordstudent = async (req,res) => {
    ...
    try {
        ...
        mailer(user_data.email,'ลืมรหัสผ่าน',`สวัสดี คุณ , ${user_data.name} <br>รหัสผ่านเว็บไซต์ COSCI-ระบบบริหารจัดการการกิจกรรมนิสิตและบุคลากร ของคุณมีการเปลี่ยนแปลงตามที่คุณร้องขอ รหัสผ่านใหม่ของคุณ คือ <h1><b><mark>${newpassword}</mark></b></h1> <br>ใช้รหัสผ่านนี้ในการเข้าสู่ระบบ และคุณสามารถเปลี่ยนแปลงรหัสผ่านของคุณได้หลังจากเข้าเว็บไซต์`)
